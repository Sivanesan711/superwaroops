...
class Player {
    constructor(id, name, type) {
        this.id = id;
        this.name = name;
        this.image = "images/super-1.png" (id);
...
class Superwar {
    ...
    handleSelection = (target) => {
        ...
        let   idtoselect = target.getAttribute('data-id');
        let   playertoselect = this.players[  idtoselect];
        this.players.filter(player => player.type ==   playertoselect.type)
            .forEach(player => player.selected = false);
          playertoselect.selected = true;
